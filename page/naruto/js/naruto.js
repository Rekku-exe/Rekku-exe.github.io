...
function actu(){
    ...
    if(state == "run"){
        document.getElementById("player").src = "./img/naruto-run-"+movement+".png";
    } else if(state == "jump") {
        if(acceleration <= 0){
            document.getElementById("player").src = "./img/naruto-jump-0.png";
        } else {
            document.getElementById("player").src = "./img/naruto-jump-1.png";
        }
    }
    killMob = false;
